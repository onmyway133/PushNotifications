...
module.exports = function (jwtString, secretOrPublicKey, options, callback) {
  ...
  payloadVerifier.use({ aud: options.audience });
  payloadVerifier.use({ iss: options.issuer });
  payloadVerifier.use({ sub: options.subject });
  payloadVerifier.use({ jti: options.jwtid });
  payloadVerifier.use(['jti']);
