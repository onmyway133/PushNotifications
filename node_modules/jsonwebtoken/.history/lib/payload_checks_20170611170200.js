...
var ClaimChecker = function(){
  this.checks = [];
}

ClaimChecker.prototype.use = function(checks) {
...
ClaimChecker.prototype.eval = function(claims, userOptions, context) {
  var i;
  var checkError;
...
module.exports.checker = ClaimChecker;
